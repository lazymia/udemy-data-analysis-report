...
Analysing the total numbers on each level of the subjects, web development had the highest number of subscribers in the four sections of the levels ( All levels, beginner level, expert level and intermediate level). This means that web development can be referred to as the oil well for the Udemy platform as many people show more interest in it than in other subjects.

When the free and paid courses were analysed, web development had the highest number of both paid and free courses beating the others by a mile.
